...
{
    [TestMethod]
    public void H5Sextent_equalTest1()
    {
        hsize_t[] dims = { 1, 2, 3 };
        ...
        Assert.IsTrue(H5S.extent_equal(space1, space) == 0);
    ...
    [TestMethod]
    public void H5Sextent_equalTest2()
    {
        Assert.IsFalse(H5S.extent_equal(Utilities.RandomInvalidHandle(),
