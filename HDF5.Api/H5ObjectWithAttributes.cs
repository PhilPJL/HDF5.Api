...
public abstract class H5ObjectWithAttributes<T> : H5Object<T>, IH5ObjectWithAttributes where T : H5ObjectWithAttributes<T>
{
    ...
    public TA ReadPrimitiveAttribute<TA>([DisallowNull] string name) where TA : unmanaged, IEquatable<TA>
    {
        ...
        return H5AAdapter.Read(attribute);
    }
    ...
    public void Enumerate(Action<H5Attribute> action)
    {
        ...
        {
            //using var h5Object = H5AAdapter.Get
            //action(h5Object);
        }
    }
        ...
        where TT : unmanaged
    {
        ...
        using var attribute = H5AAdapter.Create(this, name, type, memorySpace, attributeCtor);
